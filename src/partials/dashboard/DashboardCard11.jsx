    ...
    datasets: [
      {
        ...
        data: [3],
        backgroundColor:  tailwindConfig().theme.colors.green[300], //tailwindConfig().theme.colors.indigo[500],
    ...
    <div className="col-span-full xl:col-span-4 bg-white shadow-lg rounded-sm border border-slate-200">
      ...
      <div className="px-5 py-3">
        <div className="flex items-start">
          <div className="text-3xl font-bold text-slate-800 mr-2">25</div>
          <div className="text-sm font-semibold text-white px-1.5 bg-yellow-500 rounded-full">40%</div>
        </div>
      </div>
